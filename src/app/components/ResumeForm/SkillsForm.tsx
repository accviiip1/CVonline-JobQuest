  ...
  return (
    <Form form={form}>
      <div className="col-span-full grid grid-cols-6 gap-3">
        ...
        <InputGroupWrapper
          label="Kỹ năng nổi bật (Tùy chọn)"
          className="col-span-full"
        >
          <p className="mt-2 text-sm font-normal text-gray-600">
            Kỹ năng nổi bật là tùy chọn để làm nổi bật các kỹ năng hàng đầu, với nhiều vòng tròn hơn có nghĩa là trình độ cao hơn.
          </p>
        </InputGroupWrapper>
        ...
        {featuredSkills.map(({ skill, rating }, idx) => (
          <FeaturedSkillInput
            ...
            placeholder={`Kỹ năng nổi bật ${idx + 1}`}
