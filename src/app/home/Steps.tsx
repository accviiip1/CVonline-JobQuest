const STEPS = [
  { title: "Thêm CV PDF", text: "hoặc tạo từ đầu" },
  { title: "Xem trước thiết kế", text: "và chỉnh sửa" },
  { title: "Tải xuống CV mới", text: "và ứng tuyển với tự tin" },
];

export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-2xl bg-sky-50 bg-dot px-8 pb-12 pt-10 lg:mt-2">
      <h1 className="text-center text-3xl font-bold">3 Bước Đơn Giản</h1>
